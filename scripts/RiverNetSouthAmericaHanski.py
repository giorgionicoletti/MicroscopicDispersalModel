...
alpha_array = np.arange(30, 150, 10)
...
for alpha in alpha_array:
    ...
    np.save(path_data + f'SouthAmerica_Hanski_rhostat_alpha{alpha}.npy', rho[-1])
    print("\t time to simulate: ", measure_time.time() - t0)
    
np.save(path_data + 'SouthAmerica_Hanski_alpha_array.npy', alpha_array)
